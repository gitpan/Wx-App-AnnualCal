...
isa_ok($frame, 'MyFrame', '$frame');

$actual = $frame->build();
$ideal = 1;
is($actual, $ideal, "MyFrame package method 'build()' successfully executed");
...
$actual = $frame->update();
$ideal = 1;
is($actual, $ideal, "MyFrame package method 'update()' successfully executed");
$actual = $frame->{yeartxt}->GetValue();
